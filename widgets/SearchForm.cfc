...
component extends="contentbox.models.ui.BaseWidget" singleton{
	...
	* @type Type of search form ( content or blog )
	* @placeholder Field placeholder 
	* @buttoncss Button's css class
	* @formcss  Form's css class
	*/
	any function renderIt( string type="content", string placeholder="Search", string buttoncss="", string formcss="" ){
		var rString	= "";
		...
		saveContent variable="rString"{
			...
			#html.startForm( name="searchForm", action=cb.linkSearch(), class=arguments.formcss )#
			    <div class="input-group">
					#html.textField( name="q", placeholder=arguments.placeholder, value=local.q, class="form-control" )#
			      <span class="input-group-btn">
			        <button class="btn btn-primary #arguments.buttoncss#" type="submit"><i class="fa fa-search"></i></button>
			      </span>
			    </div>
			#html.endForm()#
			');
